  ...
  return (
    ...
    <nav className="bg-[#F2F6F6] z-50 fixed left-0 right-0 h-fit">
      <div className="container mx-auto lg:flex justify-between h-20 items-center ">
        ...
        <img src={logo} alt="" className="h-fit w-40 mx-auto lg:mx-0" />
        <div
          className={`absolute lg:static top-0 z-30 ${menu ? "left-0" : "-left-[500px]"
            } duration-1000 lg:flex gap-5 w-fit space-y-10 lg:space-y-0 h-screen lg:h-fit bg-blue-500 lg:bg-[#F2F6F6]`}
        >
          ...
          <ul className="flex lg:flex-row flex-col gap-8 bg-[#F2F6F6] w-fit mx-auto lg:mx-0 px-32 lg:p-0">
